  ...
  return (
    <section id="servicos" className="relative py-20 md:py-32 overflow-hidden">
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-12">
        ...
        {/* Services Grid - Desktop - CENTERED WITH MAX WIDTH */}
        <div className="hidden md:grid gap-6 md:gap-8 sm:grid-cols-2 lg:grid-cols-3 max-w-7xl mx-auto">
          {services.map((service, idx) => (
            <motion.div
              ...
              className="group relative bg-zinc-900/60 backdrop-blur-sm border-2 border-zinc-800 hover:border-[#00d055]/50 transition-all duration-300 overflow-hidden will-change-transform"
            >
              ...
              <div className="relative p-6 sm:p-8">
                ...
                <div className="mb-6 relative">
                  ...
                  <div className="relative inline-flex items-center justify-center w-16 h-16 bg-zinc-800 border-2 border-[#00d055]/30 group-hover:border-[#00d055] group-hover:scale-110 transition-all duration-300 will-change-transform">
        ...
        <motion.div
          ...
          className="mt-16 md:mt-20 text-center max-w-5xl mx-auto"
        >
          <div className="inline-flex flex-col sm:flex-row items-center gap-4 bg-zinc-900/80 backdrop-blur-sm border-2 border-[#00d055]/30 p-6 sm:p-8">
            ...
            <button
              onClick={open}
              className="inline-flex items-center gap-3 bg-[#00d055] hover:bg-[#00e05f] text-black font-black px-8 py-4 transition-all duration-200 hover:scale-105 active:scale-95 uppercase tracking-wider shadow-lg shadow-[#00d055]/30 border-b-4 border-[#00a043] whitespace-nowrap will-change-transform"
            >
