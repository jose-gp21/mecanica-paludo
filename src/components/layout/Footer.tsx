...
export default function Footer() {
  ...
  const pathname = usePathname(); // ✅ para identificar a rota atual
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  className="text-zinc-400 hover:text-[#00d055] transition-colors text-sm"
                >
                  (49) 99823-9818
                </a>
              </div>
              ...
              {navLinks.map((link) => {
                ...
                return (
                  <Link
                    key={link.href}
                    href={link.href}
                    className={`block text-sm font-bold uppercase transition-colors ${
                      isActive
                        ? "text-[#00d055]"
                        : "text-zinc-400 hover:text-[#00d055]"
                    }`}
                  >
                    {link.label}
                  </Link>
        ...
        <div className="border-t border-zinc-800 pt-6">
          <p className="text-center text-sm text-zinc-500">
            ...
            <span className="text-[#00d055] font-bold">Mecânica Paludo</span>.
